...
func (p MySQLPerformanceStruct) String() string {
	s, _ := json.Marshal(p)
	return string(s)
}

// MySQLPerformanceStruct - XXX
type MySQLPerformanceStruct struct {
...
func Collect() error {
	...
	MySQLPerformanceStruct := MySQLPerformanceStruct{}
	...
	MySQLPerformanceStruct.Gauges = gauges
	MySQLPerformanceStruct.Counters = counters
	...
	MySQLPerformanceStruct.TableSizeData = TableSizeData
	...
	MySQLPerformanceStruct.SlowQueriesData = SlowQueriesData
	// MySQLPerformanceStructJSON, _ := json.Marshal(&MySQLPerformanceStruct)
	fmt.Print(MySQLPerformanceStruct)
